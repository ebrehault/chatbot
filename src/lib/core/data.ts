...
const _chat = new Subject<{ question: string; answer: string[] }>();
...
const DIALOG: { question: string; answer: string[]; speak?: boolean }[] = [
  ...
  },
  {
    ...
    answer: ['Sorry, can I ask you a question?'],
  },
  ...
  { question: '', answer: ['NO STEVE! STOP!'], speak: true },
  // TODO: 'NO STEVE, STOP (image from 2001)',
];
